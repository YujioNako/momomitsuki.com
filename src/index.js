...
document.getElementById('footer').innerHTML = `<br><HR style='FILTER:alpha(opacity=100,finishopacity=0,style=3)' width='90%' color=#C0C0C0 SIZE=3><div class='mdui-container-fluid' style='max-width:1500px;'><h3 id='留言板'>留言板</h3>    <div class="mdui-table-fluid mdui-table th" style="width:100%;">
                ...
                <tbody>
                    <tr>
                        <th>
                            ...
                            <br>
                            <label class="mdui-textfield-label" style='display:none'>电邮</label>
                            <input type="text" class="mdui-textfield-input" name="contact" placeholder="或者其他联系方式（选填）" maxlength="200" style="width:98%;display:none">
                            <br>
                            <center>
